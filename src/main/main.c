...
int	main(int argc, char **argv, char **env)
{
	...
	while (1)
	{
		...
		expander(); // düğümlerin içlerindeki env değişkenler orjinal hallerine dönüştü yani $USER olan content artık icelebi oldu. contenti NULL olan lexlist node'ları freelendi
		parser(); // 
		executer();
