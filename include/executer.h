...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/25 19:52:27 by icelebi           #+#    #+#             */
/*   Updated: 2023/10/25 19:52:27 by icelebi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//BUILTIN
void	run_builtin(t_core *g_core,t_cmdlist *cmd_node, int builtin, int *fd, int fd_index);
